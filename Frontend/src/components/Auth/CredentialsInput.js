...
const CredentialsInput = (props) => {
    return (
        <div className='login_page__inputs_inner_container'>
            ...
            <Form.Control value={props.value || ""} onChange={props.onTyping} name={props.name} size="lg" type={props.type} autoFocus={props.setFocus} className={props.isWarn && 'login_page__input_field_warn'} autoComplete='off'/>
